...
def get_X(dat_path, r_mode):
    ...
    return cis_1_data, cis_2_data, radius_data
...
def get_result(dat_path, r_mode, model, output_path):
    # 7. Predic
    cis_1_data, cis_2_data, radius_data = get_X(dat_path, r_mode)
    try:
        inputs = {
            model.get_inputs()[0].name: cis_1_data,
            model.get_inputs()[1].name: cis_2_data,
            model.get_inputs()[2].name: radius_data,
        }
